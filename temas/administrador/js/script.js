...
var pesquisa = {
    ...
    ajaxConsumoObrigatorio: function ajaxConsumoObrigatorio() {
        ...
        $('.conteudo .content .table-responsive table tbody tr td .confirmar').on('click', function () {
        ...
        $('.conteudo .content .table-responsive table tbody tr td .anular').on('click', function () {
            var id = $(this).attr('data-id');
            var $this = $(this);
